...
Contact profile: Derek Okafor — Operations Manager at Summit Wellness Studio,
a Central Austin yoga and fitness space that submitted a referral inquiry in
Mar 2026 asking about weekly commercial cleaning.

Run:
    python3 create_contact_derek_okafor.py
"""
...
CONTACT = {
    "firstname":          "Derek",
    "lastname":           "Okafor",
    "email":              "d.okafor@summitwellness.example.com",
    "phone":              "(512) 702-4815",
    ...
    "neighborhood":       "Central Austin/Hyde Park",
