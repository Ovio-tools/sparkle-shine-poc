"""
One-off script: create a test HubSpot contact for Sparkle & Shine and
register the canonical ID in cross_tool_mapping.

Contact profile: Marcus Reid — commercial lead, website inquiry.

Run:
    python3 create_contact_marcus_reid.py
"""
...
CONTACT = {
    "firstname":          "Marcus",
    "lastname":           "Reid",
    "email":              "marcus.reid@keystonefacilitiesco.com",
    "company":            "Keystone Facilities Co",
    "address":            "7600 Shoal Creek Blvd",
    "city":               "Austin",
