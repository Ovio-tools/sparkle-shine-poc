...
Contact profile: Victor Harrington — commercial lead, referral.

Run:
    python3 create_contact_victor_harrington.py
"""
...
CONTACT = {
    "firstname":          "Victor",
    "lastname":           "Harrington",
    "email":              "victor.harrington@sterlingpropertyservices.com",
    "phone":              "(512) 555-0174",
