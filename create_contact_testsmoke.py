"""
One-off script: create a smoke-test HubSpot contact for Sparkle & Shine and
register the canonical ID in cross_tool_mapping.

Contact profile: TestSmoke April2026 — residential lead, website inquiry.

Run:
    python3 create_contact_testsmoke.py
"""
